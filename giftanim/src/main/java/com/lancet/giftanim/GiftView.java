...
public class GiftView extends RelativeLayout {
    ...
    private  void init(){
        ...
        mGiftLayoutInAnim = (TranslateAnimation) AnimationUtils.loadAnimation(getContext(), R.anim.gift_in);
        mIconScaleAnim = (ScaleAnimation) AnimationUtils.loadAnimation(getContext(), R.anim.icon_scale);
        mUserNameIn = (TranslateAnimation) AnimationUtils.loadAnimation(getContext(), R.anim.username_in);
        mGiftNameIn = (TranslateAnimation) AnimationUtils.loadAnimation(getContext(), R.anim.giftname_in);

        // 外层是线性布局
        LayoutInflater.from(getContext()).inflate(R.layout.layout_item_gift_animal, this);
